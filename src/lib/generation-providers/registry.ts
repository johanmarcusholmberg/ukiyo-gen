...
export const PROVIDER_MODEL_REGISTRY: ProviderModelEntry[] = [
  {
    ...
    qualityNotes: "Strong prompt-adherence, clean compositions, good for poster typography-adjacent layouts.",
    strengths: ["Prompt fidelity", "Composition control", "Poster layouts"],
    weaknesses: ["Limited aspect-ratio set", "Less photoreal nuance than SDXL"],
    enabled: true,
  },
  {
