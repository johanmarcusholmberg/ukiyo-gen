...
export const WHIMSICALJAPANESE_STYLE: StyleConfig = {
  ...
  freestyleGenerateLabel: "Generate Image",
  themedPlaceholder: "Describe your character… e.g. 'A calm frog in an indigo kimono holding a single steaming bowl of ramen, soft cream background'",
  freestylePlaceholder: "Describe any subject… e.g. 'A single clay teapot, centered, on a soft sage background'",
  prompts: {
    themed: {
      generate: [
        "A calm frog in an indigo kimono holding a single steaming bowl of ramen, centered on a soft cream background",
        "A quiet fox in a faded persimmon yukata pouring tea from a small clay kyusu, simple sage background",
        "A composed rabbit holding a single bamboo steamer of dumplings, centered on a dusty blue background",
        "A dignified cat in a sage apron presenting a single piece of nigiri, soft cream background with no other props",
        "A graceful crane gently holding a small bowl of udon, centered on a faded terracotta background",
        "A calm tanuki holding a single sake cup, centered on a soft mustard background with a faint folk pattern",
      ],
      edit: [
    ...
    freestyle: {
      generate: [
        "A single clay teapot, centered on a soft cream paper background with quiet negative space",
        "A composed owl in a small scholar's robe holding a single closed book, centered on dusty blue",
        "A single sprig of cherry blossom, centered on a faded sage background, gouache and ink",
        "A calm bear holding a single ceramic cup, centered on a soft terracotta background",
        "A single round persimmon fruit, centered on a warm cream background with subtle paper grain",
      ],
      edit: [
