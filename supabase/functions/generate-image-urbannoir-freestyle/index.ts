...
const STYLE_KEY = "urbannoir-freestyle";
...
const RULES = {
  ...
  style: ["strictly monochrome with heavy grain", "high contrast analog film look", "raw documentary aesthetic"],
  composition: ["dynamic urban-energy framing", "subject-forward with gritty texture", "edge grain and textures must be preserved"],
  color: ["black and white only — no color", "deep blacks and bright whites"],
  quality: ["authentic film grain quality", "sharp where it matters", "high detail", "sharp focus", "high resolution", "detailed textures", "print-ready resolution", "suitable for large format printing"],
